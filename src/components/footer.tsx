...
const Footer = () => {
  return (
    <footer className="bg-[#014421] text-white py-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm">
              Eco Market connects local farmers and artisans with consumers, promoting sustainability and fresh, eco-friendly products.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="text-sm space-y-1">
              <li>Email: <a href="mailto:info@ecomarket.com" className="hover:text-gray-300">info@ecomarket.com</a></li>
